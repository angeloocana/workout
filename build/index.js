...
server.tool("start-workout", "Start a new workout", {
...
server.tool("add-exercise", "Add an exercise to the current workout", {
...
server.tool("add-exercise-rep", "Add a rep to the current exercise", {
...
server.tool("end-workout", "End the current workout", {}, async () => {
    const workout = getCurrentWorkout();
